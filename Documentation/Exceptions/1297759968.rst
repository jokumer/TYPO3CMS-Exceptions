...
Another reason could be, if PHP strict_types is declared, and current method parameters have invalid or none type declaration specified.
Check and add wrong or missing type declaration for both, documented function parameters and passing function arguments.
